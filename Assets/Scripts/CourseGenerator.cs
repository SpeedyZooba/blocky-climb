...
public class CourseGenerator : MonoBehaviour
{
    ...
    public void GenerateJumpPad(bool isSingle)
    {
        ...
        if (Random.value > 0.5f)
        {
            ...
            instantiated.GetComponent<PadProcessor>().ImpulseStrength = Random.Range(jumpPadImpulseRange.x, jumpPadImpulseRange.y);
        ...
        else
        {
            ...
            instantiated.GetComponent<PadProcessor>().ImpulseStrength = Random.Range(jumpBallImpulseRange.x, jumpBallImpulseRange.y);
            jumpPads.Add(instantiated);
        }
